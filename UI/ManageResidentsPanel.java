...
import user_management.ResidentUser;
...
public class ManageResidentsPanel extends JPanel {
    ...
    public ManageResidentsPanel(User user, List<Resident> residents, List<User> users) {
        ...
        String[] columns = { "ID", "Full Name", "Age", "Sex", "Address", "Contact", "Position", "Status",
                "Household Size" };
    ...
    private void showAddResidentDialog() {
        ...
        AddEditResidentDialog dialog = new AddEditResidentDialog(getParentFrame(), null, panelResidents);
    ...
    private void editSelectedResident() {
        ...
        if (resident != null) {
            ...
            AddEditResidentDialog dialog = new AddEditResidentDialog(getParentFrame(), resident, panelResidents);
            if (dialog.showDialog()) {
        ...
        for (Resident resident : panelResidents) {
            ...
            if (resident.getFullName().toLowerCase().contains(query) ||
                ...
                String status = resident.getStatus() == Resident.ResidentStatus.DECEASED ? "Deceased"
                        : resident.getAge() >= 60 ? "Senior Citizen" : resident.getAge() <= 12 ? "Child" : "Adult";
    ...
    private void viewResidentDetails() {
        ...
        if (resident != null) {
            JDialog detailsDialog = new JDialog(getParentFrame(), "Resident Details", true);
            detailsDialog.setSize(600, 700);
            detailsDialog.setLocationRelativeTo(getParentFrame());
            ...
            addDetailRow(detailsPanel, gbc, "Birthday:", String.valueOf(resident.getDateofBirth()));
            ...
            addDetailRow(detailsPanel, gbc, "Household Head:",
