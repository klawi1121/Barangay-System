...
public class ReportsPanel extends JPanel {
    ...
    private void showAgeGroupSummary() {
        ...
        for (Resident r : reportResidents) {
            int age = r.getAge();
            if (age <= 12)
                ageGroups.put("Children (0-12)", ageGroups.get("Children (0-12)") + 1);
            else if (age <= 19)
                ageGroups.put("Teens (13-19)", ageGroups.get("Teens (13-19)") + 1);
            else if (age <= 35)
                ageGroups.put("Young Adults (20-35)", ageGroups.get("Young Adults (20-35)") + 1);
            else if (age <= 59)
                ageGroups.put("Adults (36-59)", ageGroups.get("Adults (36-59)") + 1);
            else
                ageGroups.put("Seniors (60+)", ageGroups.get("Seniors (60+)") + 1);
        }
